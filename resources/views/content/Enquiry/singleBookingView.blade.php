    ...
    <div class="mb-3 col-md-6">
      ...
      <div class="card-body">
          ...
          <div class="mb-3 col-md-6">
            ...
            <div class="mb-3 col-md-6">
              <label for="concert" class="form-label">Concert </label>
              <input class="form-control" type="text" name="concert" id="concert" value="{{$booking[0]->concert}}" readonly/>
            </div>
            ...
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" name="seats" id="seats" value="{{$booking[0]->seats}}" readonly/>
            </div>
            <div class="mb-3 col-md-6">
            ...
            {!! QrCode::size(150)->generate($booking[0]->id) !!}
